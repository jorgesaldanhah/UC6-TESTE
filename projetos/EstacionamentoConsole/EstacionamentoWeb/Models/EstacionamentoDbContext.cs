...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Clientes__3213E83FDFE28331");

            entity.HasIndex(e => e.Cpf, "UQ__Clientes__D836E71F6E38E798").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Registro__3213E83F13D4D45E");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Vagas__3213E83FDE23C583");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Veiculos__3213E83F1AFC97C7");

            entity.HasIndex(e => e.Placa, "UQ__Veiculos__0C0574250E4A1B5D").IsUnique();
