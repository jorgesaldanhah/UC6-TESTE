...
namespace EstacionamentoWeb.Controllers
{
    public class VagasController : Controller
    {
        ...
        public VagasController(EstacionamentoDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Localizacao,Tipo")] Vaga vaga)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Localizacao,Tipo")] Vaga vaga)
        {
            if (id != vaga.Id)
            {
                return NotFound();
